...
const STATUS_CLASSES: Record<string, string> = {
  idle: "text-aegis-text-muted",
  en_route: "text-aegis-accent",
  loitering: "text-aegis-success",
  rtb: "text-aegis-warning",
  low_battery: "text-aegis-warning",
  critical: "text-aegis-danger",
  offline: "text-aegis-text-muted",
  destroyed: "text-aegis-danger",
  mission_complete: "text-aegis-success",
};
...
/**
 * Left panel listing all assets with real-time status, battery, and position.
 */
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {assets.map((asset) => (
          <div
            key={asset.id}
            className="px-3 py-2.5 border-b border-aegis-border hover:bg-aegis-panel/50 cursor-pointer transition-colors"
          >
